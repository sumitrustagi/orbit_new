...
class User(UserMixin, TimestampMixin, SoftDeleteMixin, db.Model):
    ...
    # -- Microsoft 365 linkage -----------------------------------------------
    ms_user_id       = db.Column(db.String(255), nullable=True, index=True)
    ms_upn           = db.Column(db.String(255), nullable=True)
    ms_phone_number  = db.Column(db.String(30),  nullable=True)
    ms_location      = db.Column(db.String(255), nullable=True)
    ...
    # -- SSO -----------------------------------------------------------------
    sso_subject      = db.Column(db.String(512), nullable=True)
    ...
    def to_dict(self) -> dict:
        return {
            ...
            "ms_user_id":    self.ms_user_id,
            "ms_upn":        self.ms_upn,
            "ms_phone_number": self.ms_phone_number,
